...
private const val TIMED_LOGGER = "TimedLogger"
...
class TimedLogger {
    ...
    @Synchronized
    fun logTranslateEveryNMilliSeconds(
        previousXTranslation: Float,
        newXTranslation: Float,
        xScale: Float,
        previousYTranslation: Float,
        newYTranslation: Float,
        yScale: Float,
        n: Int
    ) {
        logEveryNMilliseconds(n) {
            ...
            Log.d(
                TIMED_LOGGER,
                "Previous x Translation: " + previousXTranslation + " New x Translation: " + newXTranslation + " x Scale: " + xScale
            );
            Log.d(
                TIMED_LOGGER,
                "Previous y Translation: " + previousXTranslation + " New y Translation: " + newXTranslation + " y Scale: " + xScale
            );
